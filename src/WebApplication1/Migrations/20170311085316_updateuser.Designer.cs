...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20170311085316_updateuser")]
    partial class updateuser
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("coreenginex.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("permanentAddressAddressID");
                    ...
                    b.HasIndex("permanentAddressAddressID");
            ...
            modelBuilder.Entity("coreenginex.Models.ApplicationUser", b =>
                {
                    b.HasOne("coreenginex.Models.Address", "currentAddress")
                        .WithMany()
                    ...
                    b.HasOne("coreenginex.Models.Address", "permanentAddress")
                        .WithMany()
                        .HasForeignKey("permanentAddressAddressID");
                });
        }
    }
}
